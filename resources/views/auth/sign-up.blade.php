    ...
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li class="dropdown"><a href="#" class="active" ><span>Visit</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              <li><a href="{{ url('/plan') }}"  class="active" >Plan Your Visit</a></li>
          ...
          <div class="col-lg-4">
            ...
            <div class="info">
              ...
              <div class="info-item d-flex">
                ...
                <div>
                  <h4>Location:</h4>
                  <p>kompleks Monumen Tugu Pahlawan, Jalan Pahlawan, Alun-alun Contong, Bubutan, Surabaya, Jawa Timur. </p>
                </div>
              </div><!-- End Info Item -->
